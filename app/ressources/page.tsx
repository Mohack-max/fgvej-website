            ...
            <TabsContent value="videos" className="mt-0">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
                <VideoCard
                  ...
                  duration="15:24"
                  thumbnailSrc="/placeholder.svg?height=200&width=350"
                ...
                <VideoCard
                  title="ENTREPRENEURIATS PAR OU COMMENCER"
                  ...
                  duration="07:02"
                  thumbnailSrc="/placeholder.svg?height=200&width=350"
                  videoLink=  "https://www.youtube.com/watch?v=utQLvM6Y2Ts&pp=ygUudmlkZW9zIHBvdXIgc2UgZm9ybWVyIGVuIGVudHJlcHJldW5lcmlhdCB2ZXJ0IA%3D%3D"
                />
